...
class ScheduleFragment : MainNavigationFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        scheduleViewModel.navigateToSessionAction.observe(viewLifecycleOwner, EventObserver { sessionId ->
        ...
        scheduleViewModel.shouldShowNotificationsPrefAction.observe(viewLifecycleOwner, EventObserver {
            if (it) {
