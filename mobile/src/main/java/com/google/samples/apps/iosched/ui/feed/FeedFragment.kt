...
class FeedFragment : MainNavigationFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        model.navigateToScheduleAction.observe(viewLifecycleOwner, EventObserver { withPinnedEvents ->
            openSchedule(withPinnedEvents)
        })

        model.openSignInDialogAction.observe(viewLifecycleOwner, EventObserver { openSignInDialog() })
